...
<div class="max-w-screen-xl mx-auto p-4">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <button onclick="openAddProductModal()" class="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center gap-2">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div id="products-empty" class="p-8 text-center text-gray-500 hidden">
            ...
            <button onclick="openAddProductModal()" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                Tambah Produk
            </button>
        </div>
    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 space-y-4">
                            ...
                            <div id="current-image-preview" class="hidden">
                                <div class="flex items-center gap-4">
                                    <img id="current-image" src="" alt="Current product image" class="w-20 h-20 rounded-lg object-cover">
                                    <div>
                                        <p class="text-sm font-medium text-gray-700">Gambar saat ini</p>
                                        <button type="button" onclick="removeCurrentImage()" class="text-sm text-red-600 hover:text-red-700">
                                            Hapus gambar
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div id="upload-section">
                                <div class="flex items-center justify-center w-full">
                                    <label for="image-upload" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                                        ...
                                        <input id="image-upload" type="file" class="hidden" accept="image/*" onchange="handleImageUpload(this)">
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="border-t pt-4">
                                <label for="product-image-url" class="block text-sm font-medium text-gray-700">Atau masukkan URL gambar</label>
                                <input type="url" id="product-image-url" name="image" placeholder="https://example.com/image.jpg"
                                       class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                <div id="image-error" class="hidden mt-1 text-sm text-red-600"></div>
                                <p class="mt-1 text-sm text-gray-500">URL gambar akan digunakan jika tidak ada file yang diupload</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3 justify-end pt-6">
                        ...
                        <button type="submit" id="submit-btn"
                            ...
                            <span id="submit-loading" class="hidden ml-2">
                                <svg class="animate-spin h-4 w-4 text-white inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                            </span>
