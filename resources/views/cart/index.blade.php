                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3 mb-6">
                                ...
                                <div class="flex justify-between text-lg font-semibold">
                                    <span>Total</span>
                                    <span class="text-green-600" id="cart-total">Rp
                                        {{ number_format($total, 0, ',', '.') }}</span>
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                    <svg class="w-24 h-24 mx-auto text-gray-400 mb-6" fill="none" stroke="currentColor"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.5-1.5M7 13l-1.5 1.5m0 0L8 16h8m-8-3v3m8-3v3m-8 0h8">
                        </path>
                    </svg>
                    ...
                    <a href="{{ route('products.index') }}"
                        class="inline-block bg-green-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-green-700 transition-colors">
                        Mulai Berbelanja
                    </a>
                </div>
            </div>
