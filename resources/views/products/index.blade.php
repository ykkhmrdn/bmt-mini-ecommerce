...
@section('content')
    <div class="max-w-screen-xl mx-auto p-4">
        ...
        <div id="products-loading" class="text-center py-12">
            <svg class="animate-spin w-8 h-8 mx-auto mb-2 text-green-600" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div class="p-4">
                ...
                <div class="flex items-center justify-between mb-3">
                    <span class="text-2xl font-bold text-green-600">Rp ${new Intl.NumberFormat('id-ID').format(product.price)}</span>
                ...
                <div class="flex gap-2">
                    ...
                    ${product.stock > 0 ?
                        `<button onclick="addToCart(${product.id})" class="flex-1 bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-green-700 transition-colors">
                                                    + Keranjang
                                                </button>` :
    ...
    `).join('');
        ...
        `);
            ...
            <button onclick="loadProducts(${i}, currentSearch, currentSortBy, currentSortOrder)"
                    class="px-3 py-2 text-sm font-medium ${isActive ? 'text-green-600 bg-green-50 border-green-500' : 'text-gray-500 bg-white hover:bg-gray-50'} border-t border-b border-gray-300">
                ${i}
            </button>
        `);
                }
